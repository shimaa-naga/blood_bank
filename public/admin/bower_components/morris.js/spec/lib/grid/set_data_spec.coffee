describe 'Morris.Grid#setData', ->
  ...
  it 'should not alter clients-supplied data', ->
  ...
  describe 'ymin/ymax', ->
    ...
    it 'should use a clients-specified minimum and maximum value', ->
    ...
    describe 'auto [n]', ->
      ...
      it 'should use a clients-specified minimum and maximum value given no data', ->
        line = Morris.Line $.extend @defaults,
          data: [{x: 1}, {x: 2}, {x: 3}, {x: 4}]
          ymin: 'auto 5'
          ymax: 'auto 20'
  ...
  describe 'timestamp data', ->
    ...
    it 'should use a clients-supplied formatter for labels', ->
      line = Morris.Line
        element: 'graph'
        data: [
